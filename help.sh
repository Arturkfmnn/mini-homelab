...
echo ""
echo "📋 Prerequisites for remote deployment:"
echo "  • SSH key-based authentication to target hosts"
echo "  • Target hosts must be reachable via SSH"
echo "  • For fresh installs: machines must be booted from NixOS installer"
echo ""
...
echo ""
echo "💡 Tips:"
echo "  • Always run 'flake check' before deploying"
echo "  • Test configurations locally first"
echo "  • Keep SSH keys in ~/.ssh/ with proper permissions"